  ...
  return (
    <main className="shell">
      <section className="card">
        ...
        <p>
          Assign the employees who are authorised to complete the reviewer and final assessment stages for each performance plan.
        </p>

        <div className="actions">
          <Link className="button secondary" href="/admin/performance">
            Back to performance configuration
          </Link>
        ...
        <div className="card">
          ...
          <button className="button" onClick={() => loadOrganisation(organisationId)}>
            Load
          </button>
        </div>
                ...
                <select value={planId} onChange={(e) => setPlanId(e.target.value)}>
                  ...
                  {plans.map((plan) => (
                    <option key={plan.id} value={plan.id}>
                      {plan.employee.user.firstName} {plan.employee.user.lastName}
                    </option>
                  ))}
                </select>
              </label>
            ...
            {planId && (
              <div className="grid">
                ...
                <div className="card">
                  ...
                  <select value={finalAssessorId} onChange={(e) => setFinalAssessorId(e.target.value)}>
                    <option value="">Unassigned</option>
                    {candidates.map((candidate) => (
                      <option key={candidate.id} value={candidate.id}>
                        {candidate.firstName} {candidate.lastName}
